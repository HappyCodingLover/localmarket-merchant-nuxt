  ...
  actions: {
      ...
      return new Promise((resolve, reject) => {
        axios({
          url:
            ...
            "/partners/mycompany/deliveryZones/" +
            id,
          method: "DELETE",
        })
          .then((resp) => {
    ...
    addDeliveryZone({ commit }, data) {
      ...
      return new Promise((resolve, reject) => {
        axios({
          url:
            process.env.VUE_APP_API_URL + "/partners/mycompany/deliveryZones",
          data,
          method: "POST",
        })
          .then((resp) => {
    ...
    reviseDeliveryCostInformation({ commit }, data) {
      ...
      return new Promise((resolve, reject) => {
        axios({
          url:
            process.env.VUE_APP_API_URL +
            "/partners/mycompany/delivery_cost_information",
          data,
          method: "POST",
        })
          .then((resp) => {
    ...
    reviseDeliveryTimeInformation({ commit }, data) {
      ...
      return new Promise((resolve, reject) => {
        axios({
          url:
            process.env.VUE_APP_API_URL +
            "/partners/mycompany/delivery_time_information",
          data,
          method: "POST",
        })
          .then((resp) => {
        ...
        axios({
          ...
          .then((resp) => {
            if (resp.data.success) {
              ...
              commit(
                "setActiveProductsWithoutPromo",
                data.active_products_without_promo
              );
    ...
    deleteSubcategory({ commit }, id) {
      ...
      return new Promise((resolve, reject) => {
        axios({
          url:
            process.env.VUE_APP_API_URL +
            "/partners/mycompany/subcategory/" +
            id,
          method: "DELETE",
        })
          .then((resp) => {
    ...
    deleteProductById({ commit }, id) {
      ...
      return new Promise((resolve, reject) => {
        axios({
          url:
            process.env.VUE_APP_API_URL + "/partners/mycompany/product/" + id,
          method: "DELETE",
        })
          .then((resp) => {
            if (resp.data.success) {
    ...
    revisePromoInformation({ commit }, data) {
      ...
      return new Promise((resolve, reject) => {
        axios({
          url:
            process.env.VUE_APP_API_URL +
            "/partners/mycompany/promo_information",
          data,
          method: "POST",
        })
          .then((resp) => {
    ...
    deleteProductImage({ commit }, id) {
      ...
      return new Promise((resolve, reject) => {
        axios({
          url:
            process.env.VUE_APP_API_URL +
            "/partners/mycompany/product/image/" +
            id,
          method: "DELETE",
        })
          .then((resp) => {
